...
const Footer = () => {
  return (
    <div className="container mx-auto my-10">
      <div className="bg-[#0000] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 lg:gap-10 px-10 py-10 rounded-3xl items-center justify-center ">
